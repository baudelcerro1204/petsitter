...
import { Services, GeneralServices } from './components/user/ServiceList';
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}> {/* Ruta protegida */}
          ...
          <Route path="/supplier-panel/services-list" element={<ServiceList />} />
          <Route path="/supplier-panel/services-list/register" element={<ServiceRegister />} />
          <Route path="/supplier-panel/consultations" element={<Consultations />} />
